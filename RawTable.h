#ifndef _RAW_TABLE_CLASS
#define _RAW_TABLE_CLASS
#include "BDDUtil.h"
...
public:
    ...
    RawTable(char *fName, NewToRawLookUpTable <T,V> * & lookUpTable){
        ...
        lookUpTable = new NewToRawLookUpTable <T,V> (TotalCapacity, BucketMask);
    ...
    bool ValidateAndReturnRawID (BDDNode <T,V,L> key, BDDPointer <T,V> & id) {
        ...
        cout << "can't find the node: RawTable, ValidateAndReturnRawID " << endl; // this is an impossible situation if every thing is all right
